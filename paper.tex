...
$\Omega_{\pm}$ is the complete phase acquired by a wavepacket in adiabatically traversing orbit $\pm$, i.e., $\Omega$ sums both rapidly- and slowly-varying components of the semiclassical phase [\red{cf.\ \s{sec:slowvariation}}], as well as the quantum Maslov correction ($\gamma_{\pm}{=}\pi$) for circular orbits. A quantization rule analogous to \q{coscos} was previously derived by us for a II-Dirac point that intermediates an electron- and hole-like orbit [AALG]. 
